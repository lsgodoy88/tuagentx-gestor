...
const clientes = JSON.parse(fs.readFileSync('/srv/gestor/tmp_import/900045626lum_clientes.json'))
...
async function main() {
  ...
  for (const c of clientes) {
    ...
    const r = {
      apiId,
      empresaId: 'cmn7oiutk0001vmega46373b4',
  ...
  console.log('Lumeli creados:', created, 'actualizados:', updated)
  await p.$disconnect()
}
