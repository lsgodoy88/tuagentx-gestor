...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
    <div aria-hidden="true" style={{position:'fixed',top:0,left:0,right:0,height:'100lvh',zIndex:-1,background:'linear-gradient(160deg, #060f2c 0%, #0a1628 12%, #1a3060 30%, #1e3a6e 48%, #0d1f45 65%, #07102c 82%, #0a1638 100%)'}} />
    <div aria-hidden="true" style={{position:'fixed',top:0,left:0,right:0,height:'100lvh',zIndex:-1,background:'radial-gradient(ellipse at 10% 20%, rgba(37,99,235,0.65) 0%, transparent 38%), radial-gradient(ellipse at 85% 10%, rgba(5,12,42,0.70) 0%, transparent 35%), radial-gradient(ellipse at 60% 50%, rgba(59,130,246,0.50) 0%, transparent 42%), radial-gradient(ellipse at 5% 80%, rgba(5,12,42,0.60) 0%, transparent 30%), radial-gradient(ellipse at 90% 75%, rgba(29,78,216,0.55) 0%, transparent 40%), radial-gradient(ellipse at 45% 90%, rgba(5,12,42,0.50) 0%, transparent 28%), radial-gradient(ellipse at 75% 35%, rgba(96,165,250,0.30) 0%, transparent 35%)'}} />
    ...
    <div className="flex min-h-screen" style={{background:'transparent'}}>
      ...
      {drawerOpen && (
        <div className="fixed inset-0 z-[998] md:hidden"
          style={{background:'rgba(5,12,42,0.35)'}}
