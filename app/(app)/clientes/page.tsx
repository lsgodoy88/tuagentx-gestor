      ...
      render: (c: any) => {
        ...
        return (
          <div style={{ display: 'flex', gap: 6, justifyContent: 'center', alignItems: 'center' }}>
            ...
            <button onClick={e => { e.stopPropagation(); ctx.router.push(`/visitas?tab=historial&q=${encodeURIComponent(c.nombre)}`) }}
                ...
                <>
                  {clientesFiltrados.map((c: any) => (
                    <ClienteCardRol
                      ...
                      onHistorial={() => router.push(`/visitas?tab=historial&q=${encodeURIComponent(c.nombre)}`)}
