            ...
            <>
              ...
              <div className="p-4 border-t border-zinc-800 flex-shrink-0 space-y-2">
                ...
                <div className="relative">
                  ...
                  {showTipoDropdown && (
                    <div className="absolute bottom-full left-0 right-0 mb-1  rounded-xl overflow-hidden shadow-xl z-10" style={{background:"#1e2030",border:"1px solid rgba(59,130,246,0.20)"}}>
                      {TIPOS.map(t => (
                        <button
                          key={t.id}
                          onClick={() => {
