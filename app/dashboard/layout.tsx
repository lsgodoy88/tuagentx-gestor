  ...
  return (
    <div className="h-screen flex overflow-hidden" style={{
      ...
      <div className="fixed inset-0 pointer-events-none" style={{
        background: 'linear-gradient(135deg, rgba(4,4,14,0.80) 0%, rgba(6,6,20,0.75) 100%)',
        zIndex: -1,
      }} />
      ...
      <aside
        ...
        className={`${collapsed && !hovered ? 'w-16' : 'w-64'} flex-col transition-all duration-200 h-full hidden md:flex flex-shrink-0" style={{background:"var(--card-bg)",borderRight:"1px solid var(--border-blue)"}}`}>
