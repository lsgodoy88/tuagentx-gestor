...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    <div aria-hidden="true" style={{position:'fixed',zIndex:-1,width:350,height:350,borderRadius:'50%',background:'rgba(236,72,153,0.22)',top:'30%',right:-100,filter:'blur(80px)',pointerEvents:'none'}} />
    <div aria-hidden="true" style={{position:'fixed',zIndex:-1,width:300,height:300,borderRadius:'50%',background:'rgba(16,185,129,0.18)',bottom:80,left:60,filter:'blur(80px)',pointerEvents:'none'}} />
    <div aria-hidden="true" style={{position:'fixed',zIndex:-1,width:320,height:320,borderRadius:'50%',background:'rgba(245,158,11,0.15)',bottom:-80,right:80,filter:'blur(80px)',pointerEvents:'none'}} />
    ...
    <div className="h-screen flex" style={{background:'transparent'}}>
      ...
      <main className="flex-1 flex flex-col min-w-0 w-0">
        ...
        <div className={`flex-1 overflow-x-auto overflow-y-auto p-4 md:p-6 pb-20 md:pb-6${bloqueado ? ' pointer-events-none opacity-50' : ''}`}>
