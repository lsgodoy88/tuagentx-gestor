  ...
  if (user?.role === 'superadmin') {
    ...
    return (
      <div className="space-y-6 pb-20 max-w-5xl mx-auto">
        ...
        <div className="rounded-2xl overflow-hidden" style={{background:"rgba(255,255,255,0.10)",border:"1px solid rgba(255,255,255,0.15)",boxShadow:"0 4px 16px rgba(0,0,0,0.20)"}}>
      ...
      {(isEmpresa || isSupervisor) && (
        <div className="space-y-6">
          ...
          {stats.visitasPorDia && stats.visitasPorDia.length > 0 && (
            <div className="rounded-2xl p-4" style={{background:"rgba(255,255,255,0.10)",border:"1px solid rgba(255,255,255,0.15)",boxShadow:"0 4px 16px rgba(0,0,0,0.20)"}}>
          ...
          {monitor.length > 0 && (
            <div className="space-y-4">
              {['vendedor', 'impulsadora', 'entregas'].map(rol => {
                ...
                return (
                  <div key={rol} className="rounded-2xl overflow-hidden" style={{background:"rgba(255,255,255,0.10)",border:"1px solid rgba(255,255,255,0.15)",boxShadow:"0 4px 16px rgba(0,0,0,0.20)"}}>
                    <div className="px-4 py-3 border-b border-zinc-800">
