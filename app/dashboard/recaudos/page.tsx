  ...
  return (
    <div className="space-y-4 pb-28 max-w-7xl mx-auto">
      ...
      <div style={{display:'flex',gap:8,width:'100%',alignItems:'stretch'}}>
        {/* 25% — Efectivo */}
        <div style={{flex:'0 0 25%',background:'rgba(8,8,28,0.88)',border:'1px solid rgba(59,130,246,0.45)',borderRadius:'0.75rem',display:'flex',alignItems:'center',justifyContent:'center',padding:'8px 12px',minWidth:0}}>
        ...
        {isAdmin && (
          <div style={{flex:1,background:'rgba(8,8,28,0.88)',border:'1px solid rgba(59,130,246,0.45)',borderRadius:'0.75rem',minWidth:0,overflow:'hidden'}}>
            <select
              value={vendedorId}
        ...
        <div style={{position:'relative',flexShrink:0}}>
          <div style={{background:'rgba(8,8,28,0.88)',border:'1px solid rgba(59,130,246,0.45)',borderRadius:'0.75rem',padding:'8px 14px',display:'flex',alignItems:'center',justifyContent:'center',cursor:'pointer',height:'100%',boxSizing:'border-box'}}>
        ...
        <button
          ...
          disabled={validando}
          style={{flexShrink:0,background:'rgba(8,8,28,0.88)',border:'1px solid rgba(59,130,246,0.45)',borderRadius:'0.75rem',padding:'8px 16px',fontSize:12,fontWeight:700,color:validando?'rgba(255,255,255,0.4)':'white',cursor:validando?'not-allowed':'pointer',whiteSpace:'nowrap'}}>
