...
const SUPERVISOR = { user: { id: 'sup-1', role: 'supervisor', empresaId: 'emp-1', permisos: { verRecaudos: true } } } as any
...
describe('GET /api/recaudos — lista de pagos (admin only)', () => {
  ...
  describe('auth + autorización', () => {
    ...
    it('rol supervisor con permiso verRecaudos → pasa el guard', async () => {
